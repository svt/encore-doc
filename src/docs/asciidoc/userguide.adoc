...
At the moment there are no *pre-ready-to-go* installation packages, pods, docker images offered for *Encore*, but fear not - there are a few possibilities in how to get going. Continue reading!
...
===== Option: Run a local version with Spring Boot bootRun for a test trial
...
===== Option: Run Encore in a Docker Image

This quickstart option will show you how to use https://docs.brew.sh/Homebrew-on-Linux[Homebrew] and creating an FFmpeg Docker Image to run Encore from.
